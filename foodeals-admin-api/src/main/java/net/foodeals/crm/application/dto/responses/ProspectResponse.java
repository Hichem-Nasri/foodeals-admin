...
public record ProspectResponse(UUID id, String createdAt, String companyName, String category, ContactDto contact, AddressDto address, CreatorInfoDto creatorInfo, ManagerInfoDto managerInfo, String eventObject, ProspectStatus status) {
}

...
//    public ResponseEntity<ArticleDto> getArticleByUuid(@RequestParam("uuid") String uuid) {
...
//    public ResponseEntity<ArticleDto> createAnArticle(CreateArticleDto createArticleDto) {
...
//    public ResponseEntity<ArticleDto> updateAnArticle(@RequestParam("uuid") String uuid, @RequestBody UpdateArticleDto updateArticleDto) {
...
//    public ResponseEntity<ArticleDto> deleteAnArticle(@RequestParam("uuid") String uuid) {

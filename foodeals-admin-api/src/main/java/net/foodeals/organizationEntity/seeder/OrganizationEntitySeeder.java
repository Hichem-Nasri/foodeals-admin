...
////        OrganizationEntity firstOrganization = this.organizationEntityRepository.findById(UUID.fromString("e6cadc8b-3d42-4056-a700-debba381d39b")).orElse(null);
////        UUID publisherId = firstOrganization.getId();
////
////        // Create Offer
////        Offer offer = new Offer();
////        offer.setPrice(new Price(BigDecimal.valueOf(100), Currency.getInstance("USD")));
////        offer.setSalePrice(new Price(BigDecimal.valueOf(80), Currency.getInstance("USD")));
...
////        order1.setPrice(new Price(BigDecimal.valueOf(50), Currency.getInstance("USD")));
////        order1.setOffer(offer);  // Attach the order to the offer
////
////        // Create Order 2
////        Order order2 = new Order();
////        order2.setPrice(new Price(BigDecimal.valueOf(30), Currency.getInstance("USD")));
...
////        transaction1.setPrice(new Price(BigDecimal.valueOf(20), Currency.getInstance("USD")));
...
////        transaction2.setPrice(new Price(BigDecimal.valueOf(15), Currency.getInstance("USD")));
...
////        transaction3.setPrice(new Price(BigDecimal.valueOf(15), Currency.getInstance("USD")));
...
////        transaction4.setPrice(new Price(BigDecimal.valueOf(10), Currency.getInstance("USD")));
...
////        transaction5.setPrice(new Price(BigDecimal.valueOf(10), Currency.getInstance("USD")));
...
//        // Get the first organization to set as the publisher
//        System.out.println("seed ");
//        OrganizationEntity firstOrganization = this.organizationEntityRepository.findById(UUID.fromString("21fef569-9028-40da-92d6-155a657fc2ca")).orElse(null);
//        UUID publisherId = firstOrganization.getId();
//
